...
namespace PresentationGenerator
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Initialize(out DateTime currentDate, out DirectoryInfo temporaryFolder);
            string filePath = System.IO.Path.Combine(temporaryFolder.FullName, string.Format("Presentation_{0:00}-{1:00}-{2:00}-{3:00}{4:00}{5:00}.pptx", currentDate.Year, currentDate.Month, currentDate.Day, currentDate.Hour, currentDate.Minute, currentDate.Second));
        ...
        private static void Initialize(out DateTime currentDate, out DirectoryInfo temporaryFolder)
        {
