...
using ExcelToDbfConvertor.Models.AccountViewModels;
...
namespace ExcelToDbfConvertor.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return View(GetAuthInfo(nameof(Index), nameof(AccountController)));
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Autentificare esuata : User sau parola invalida!");
                    return View(model);
                }
            }
